...
ggbetweenstats(
  ...
  type = "parametric",
  messages = FALSE,
  title = "Dochód całkowity a decyzja kredytowa",
...
ggbetweenstats(
  ...
  type = "parametric",
  messages = FALSE,
  title = "Kwota kredytu a decyzja kredytowa",
  xlab = "Decyzja kredytowa",
  ylab = "Kwota kredytu"
)
```
...
ggbetweenstats(
  ...
  type = "nonparametric",
  messages = FALSE,
  title = "Okres kredytowania a decyzja",
  xlab = "Decyzja",
  ylab = "Okres (miesiące)"
)
```
...
ggbetweenstats(
  ...
  type = "parametric",
  messages = FALSE,
  title = "Obszar zamieszkania a kwota kredytu",
  xlab = "Obszar",
  ylab = "Kwota kredytu"
)
```
